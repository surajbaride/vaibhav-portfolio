  ...
  return (
    <footer className="footer">
      <div style={{display:'flex',gap:12,alignItems:'center',justifyContent:'center',flexWrap:'wrap'}}>
        <div>© 2026 Vaibhav Hipparge</div>
        <div style={{display:'flex',gap:8,alignItems:'center'}}>
          <a className="icon-btn" href="mailto:vaibhavhipparge@gmail.com"> 
          ...
          <a className="icon-btn" href="https://www.linkedin.com/in/vaibhavhipparge" target="_blank" rel="noreferrer">
          ...
          <a className="icon-btn" href="https://wa.me/917972736496" target="_blank" rel="noreferrer">
